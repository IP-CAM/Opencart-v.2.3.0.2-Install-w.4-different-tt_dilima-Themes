          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-4 col-sm-12">
				...
				<table id="module-content-block1" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block1; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block1');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-content-block10" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_content_block10; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('content-block10');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-top-banner" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_top_banner; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('top-banner');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
				...
				<table id="module-top-banner1" class="table table-striped table-bordered table-hover">
                  <thead>
                  <tr>
                    <td class="text-center"><?php echo $text_top_banner1; ?></td>
                  </tr>
                  </thead>
                  <tbody>
                  <?php foreach ($layout_modules as $layout_module) { ?>
                  ...
                  <tr>
                    <td class="text-left"><div class="input-group">
                        ...
                        <div class="input-group-btn">
                          <button type="button" onclick="addModule('top-banner1');" data-toggle="tooltip" title="<?php echo $button_module_add; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i></button>
                        </div>
                      </div></td>
                  </tr>
                  </tfoot>
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-block,#module-content-block1,#module-content-block2,#module-content-block3,#module-content-block4,#module-content-block5,#module-content-block6,#module-content-block7,#module-content-block8,#module-content-block9,#module-content-block10,#module-content-banner,#module-top-banner,#module-top-banner1').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-content-block, #module-content-block1, #module-content-block2, #module-content-block3, #module-content-block4, #module-content-block5, #module-content-block6, #module-content-block7,#module-content-block8,#module-content-block9,#module-content-block10,#module-content-banner,#module-top-banner,#module-top-banner1').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>