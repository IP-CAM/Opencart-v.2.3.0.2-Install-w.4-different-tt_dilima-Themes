...
class ControllerExtensionModuleOCvermegamenu extends Controller {
	public function index($setting) { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/stylesheet/opentheme/vermegamenu/css/ocvermegamenu.css')) {
			$this->document->addStyle('catalog/view/theme/'. $this->config->get($this->config->get('config_theme') . '_directory') .'/stylesheet/opentheme/vermegamenu/css/ocvermegamenu.css');
		} else {
